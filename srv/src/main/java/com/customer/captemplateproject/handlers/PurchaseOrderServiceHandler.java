...
import cds.gen.com.customer.captemplateproject.Upload;
import cds.gen.com.customer.captemplateproject.Upload_;
...
public class PurchaseOrderServiceHandler implements EventHandler {
    ...
    public void handleExcelUpload(CdsUpdateEventContext context, Upload upload) {
        ...
        if (is != null) {
            ...
            EasyExcel.read(is, new NoModelDataListener(db)).sheet().headRowNumber(1).doRead();
        }
